...
<div class="mx-auto max-w-2xl">
  ...
  <p class="mb-6 text-sm text-gray-500">
    Enable or disable features for this classroom. Disabled features will be hidden from students and teachers.
  </p>
        ...
        >
          ...
          <div class="relative ml-4">
            <input
              ...
              class="peer sr-only"
            />
            <div class="h-6 w-11 rounded-full bg-gray-300 transition-colors peer-checked:bg-forge-blue peer-disabled:cursor-not-allowed"></div>
